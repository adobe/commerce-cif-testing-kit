...
public class PostShoppinglistsTest extends CloudTest {
    
    private CloudSampleActions actions;

    public PostShoppinglistsTest() {
    }

    public PostShoppinglistsTest(CloudSampleActions actions) {
        this.actions = actions;
    }
    
    @Override
    public void test() throws Throwable {
        this.actions = new CloudSampleActions(benchmark().measure(this, "postShoppingList", getDefaultClient()));
    ...
    public AbstractTest newInstance() {
        return new PostShoppinglistsTest();
    }
}