...
public class PostCartsTest extends CloudTest {
    
    private CloudSampleActions actions;

    public PostCartsTest() {
    }

    public PostCartsTest(CloudSampleActions actions) {
        this.actions = actions;
    }
    
    @Override
    public void test() throws Throwable {
        this.actions = new CloudSampleActions(benchmark().measure(this, "postCart", getDefaultClient()));
