...
public class PostCartsIdEntriesTest extends CloudTest {
    
    private CloudSampleActions actions;

    public PostCartsIdEntriesTest() {
    }

    public PostCartsIdEntriesTest(CloudSampleActions actions) {
        this.actions = actions;
    }
    
    @Override
    public void test() throws Throwable {
        this.actions = new CloudSampleActions(benchmark().measure(this, "postCartEntry", getDefaultClient()));
    ...
    public AbstractTest newInstance() {
        return new PostCartsIdEntriesTest();
    }
}