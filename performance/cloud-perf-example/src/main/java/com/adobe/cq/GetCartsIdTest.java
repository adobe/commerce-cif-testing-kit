...
public class GetCartsIdTest extends CloudTest {
    
    private CloudSampleActions actions;

    public GetCartsIdTest() {
    }

    public GetCartsIdTest(CloudSampleActions actions) {
        this.actions = actions;
    }
    
    @Override
    public void test() throws Throwable {
        this.actions = new CloudSampleActions(benchmark().measure(this, "getCart", getDefaultClient()));
