...
public class GetProductsSearchTest extends CloudTest {
    
    private CloudSampleActions actions;

    public GetProductsSearchTest() {
    }

    public GetProductsSearchTest(CloudSampleActions actions) {
        this.actions = actions;
    }
    
    @Override
    public void test() throws Throwable {
        this.actions = new CloudSampleActions(benchmark().measure(this, "searchProducts", getDefaultClient()));
    ...
    public AbstractTest newInstance() {
        return new GetProductsSearchTest();
    }
}