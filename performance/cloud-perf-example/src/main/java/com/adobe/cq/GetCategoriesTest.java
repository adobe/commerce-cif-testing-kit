...
public class GetCategoriesTest extends CloudTest {
    ...
    public GetCategoriesTest(CloudSampleActions actions) {
        this.actions = actions;
    }
    
    @Override
    public void test() throws Throwable {
        this.actions = new CloudSampleActions(benchmark().measure(this, "getCategories", getDefaultClient()));
