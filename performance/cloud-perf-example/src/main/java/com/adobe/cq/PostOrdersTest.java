...
public class PostOrdersTest extends CloudTest {
    ...
    public PostOrdersTest(CloudSampleActions actions) {
        this.actions = actions;
    }
    
    @Override
    public void test() throws Throwable {
        this.actions = new CloudSampleActions(benchmark().measure(this, "postOrder", getDefaultClient()));
