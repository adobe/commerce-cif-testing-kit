...
public class DeleteCartsIdTest extends CloudTest {
    
    private CloudSampleActions actions;

    public DeleteCartsIdTest() {
    }

    public DeleteCartsIdTest(CloudSampleActions actions) {
        this.actions = actions;
    }
    
    @Override
    public void test() throws Throwable {
        this.actions = new CloudSampleActions(benchmark().measure(this, "deleteCart", getDefaultClient()));
